    ...
    <body> 
                ...
                <div class="row">
                    <div class="col-md-3">
                        <nav class="navbar bg-light">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="index"><i class="fa fa-home"></i>Domů</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-shopping-bag"></i>Nejprodávanější</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#"><i class="fa fa-plus-square"></i>Novinky</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-md-6">
                        <div class="header-slider normal-slider">
                            <div class="header-slider-item">
                                <img src="assets/eshop/img/slider-3.jpg" alt="Slider Image" />
                                    <p class="slider-p">Zákaznická podpora 24/7</p>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="category-item ch-400">
                            <img src="assets/eshop/img/category-3.jpg" />
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-250">
                            <img src="assets/eshop/img/category-4.jpg" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                        <div class="category-item ch-150">
                            <img src="assets/eshop/img/category-5.jpg" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-150">
                            <img src="assets/eshop/img/category-6.jpg" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                        <div class="category-item ch-250">
                            <img src="assets/eshop/img/category-7.jpg" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="category-item ch-400">
                            <img src="assets/eshop/img/category-8.jpg" />
                            <a class="category-name" href="">
                                <p>Some text goes here that describes the image</p>
                            </a>
                        </div>
        ...
        <div class="call-to-action">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <h1>V případě dotazů nás kontaktujte</h1>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="newsletter">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <h1>Přihlašte se k odběru novinek </h1>
                    </div>
                    <div class="col-md-6">
                        <div class="form">
                            <input type="email" value="Zadejte váš email">
            ...
            <div class="container-fluid">
                <div class="row align-items-center review-slider normal-slider">
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="assets/eshop/img/review-1.jpg" alt="Image">
                            </div>
                            <div class="review-text">
                                <h2>Jméno zákazníka</h2>
                                <h3>Profese</h3>
                                <div class="ratting">
                                    <i class="fa fa-star"></i>
                                    <i class="fa fa-star"></i>
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="assets/eshop/img/review-2.jpg" alt="Image">
                            </div>
                            <div class="review-text">
                                <h2>Jméno zákazníka</h2>
                                <h3>Profese</h3>
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="assets/eshop/img/review-3.jpg" alt="Image">
                            </div>
                            <div class="review-text">
                                <h2>Jméno zákazníka</h2>
                                <h3>Profese</h3>
                    ...
                    <div class="col-md-6">
                        <div class="review-slider-item">
                            <div class="review-img">
                                <img src="assets/eshop/img/review-4.jpg" alt="Image">
                            </div>
                            <div class="review-text">
                                <h2>Jméno zákazníka</h2>
                                <h3>Profese</h3>
